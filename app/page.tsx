...
const baseRow1 = [
  { name: "Bintang Fitrah Ramad...", handle: "@bbinntr", text: "sangat worth it untuk menambah pengalaman dan ilmu be...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=BF" },
  { name: "Muhamad Irqa Khoirul...", handle: "@mikmself", text: "Logis dan realistis dalam menyelesaikan masalah, minu...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=MI" },
  { name: "Nugroho Mohamad Al a...", handle: "@dejunn__8", text: "Sangat dapat diandalkan, menunjukkan integritas tingg...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=NM" },
  { name: "Habib Muhammad...", handle: "@habibmuhd_", text: "Beliau ini sangat sepuh kalo urusan desain grafis, ui...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=HM" },
];
const testimonialsRow1 = [...baseRow1, ...baseRow1];

const baseRow2 = [
  { name: "Sidiq Nur Fahreza", handle: "@surfaxo", text: "Kerja cerdas🔥", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=SN" },
  { name: "fabianus kevin s...", handle: "@fabianus-kevin-406285231", text: "sigap langsung to the point, sikap profesional, the b...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=FK" },
  { name: "Evnx studio...", handle: "@saifarizal", text: "Kemampuan yang diluar nalar sudah di tahap master dan...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=ES" },
  { name: "dinuuuu...", handle: "@your_future", text: "Produknya sangat bagus dan sangat memuaskan...", image: "https://placehold.co/100x100/2a2a2a/ffffff?text=DU" },
];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-zinc-800 font-sans">
      ...
      <div className="w-full flex justify-center pt-6 px-4 absolute top-0 z-50">
        ...
        <nav className="flex items-center justify-between pl-5 pr-2 py-2 max-w-[1200px] w-full bg-zinc-900/80 backdrop-blur-md rounded-full border border-zinc-800 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="#" className="px-7 py-2.5 rounded-full bg-white text-black font-semibold text-[13.5px] hover:bg-zinc-200 transition-colors">
              Login
            </Link>
          </div>
      ...
      <main className="max-w-[1200px] mx-auto px-8 pt-32 md:pt-56 pb-20">
        <h1 className="text-[40px] md:text-[52px] lg:text-[56px] leading-[1.1] font-semibold tracking-[-0.02em] text-white mb-8">
          Ben Roach is a hands-on design leader & strategist who builds world-class tech products.
        </h1>
        
        <p className="font-mono text-[19px] md:text-[21px] text-zinc-400 leading-[1.6] mb-14 max-w-[760px]">
          <span className="text-zinc-100 font-medium">UX Leader</span> and <span className="text-zinc-100 font-medium">Principal Designer</span> with <span className="text-zinc-100 font-medium">17 years</span> of experience turning ambiguity into measurable business impact. Currently at <span className="text-zinc-100 font-medium">Google</span>, building the future of AI-powered cyber defense. Previously at <span className="text-zinc-100 font-medium">Amazon</span>.
        </p>

        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 sm:gap-6">
          <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
            <a href="#" className="flex items-center justify-center gap-2.5 bg-white text-black px-6 py-2.5 rounded-full font-medium text-[15px] hover:bg-zinc-200 transition-colors w-full sm:w-auto">
              Contact me
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
            </a>
            
            <a href="#" className="flex items-center justify-center gap-2.5 border border-zinc-700 text-white px-6 py-2.5 rounded-full font-medium text-[15px] hover:bg-zinc-800 transition-colors w-full sm:w-auto">
              Download CV
          ...
          <div className="flex items-center gap-6 text-white w-full sm:w-auto justify-end">
            <a href="#" className="hover:text-zinc-400 transition-colors" aria-label="LinkedIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#12121A] rounded-xl p-8 border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-[14px] leading-[1.6] font-mono">
              Creating pixel-perfect, responsive websites and user interfaces using HTML, CSS, JavaScript, React, and modern frameworks.
            </p>
          </div>
          ...
          <div className="bg-[#12121A] rounded-xl p-8 border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-[14px] leading-[1.6] font-mono">
              Building robust backend systems with APIs, databases, authentication, and server logic using Node.js, PHP, Python, or other technologies.
            </p>
          </div>
          ...
          <div className="bg-[#12121A] rounded-xl p-8 border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-[14px] leading-[1.6] font-mono">
              Setting up CI/CD pipelines, cloud hosting, containerization (Docker), domain setup, and performance optimization for fast and reliable deployments.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="max-w-[1200px] mx-auto px-8 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Project 1 */}
          <div className="bg-[#12121A] rounded-xl overflow-hidden border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col">
            <div className="h-48 w-full bg-zinc-800 relative">
              <img src="https://placehold.co/600x400/2a2a2a/ffffff?text=Velora+2025" alt="Velora 2025" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-[17px] font-bold text-white mb-2 leading-tight">Velora 2025 Event Management & Merch Store</h3>
              <p className="text-[#60A5FA] text-[13px] font-medium mb-4">Laravel, Alpinejs, TailwindCSS, MySQL</p>
              <p className="text-zinc-400 text-[14px] leading-[1.6]">
                Unified event registration and e-commerce platform with integrated payment gateways. I developed the core business logic and a centralized admin dashboard for multi-channel operations. This architecture maximized user conversion for both tickets and merchandise sales.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#12121A] rounded-xl overflow-hidden border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col">
            <div className="h-48 w-full bg-zinc-800 relative">
              <img src="https://placehold.co/600x400/2a2a2a/ffffff?text=UMP+Bersepeda" alt="UMP Bersepeda" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-[17px] font-bold text-white mb-2 leading-tight">UMP Bersepeda 2025 Event Management</h3>
              <p className="text-[#60A5FA] text-[13px] font-medium mb-4">Laravel, Alpinejs, TailwindCSS</p>
              <p className="text-zinc-400 text-[14px] leading-[1.6]">
                Robust tracking system managing racepack distribution and email verification for 3,000+ participants. I led the logistics flow development to ensure 100% accuracy in BIB and shirt allocation. The system eliminated identity errors and significantly reduced manual check-in times.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#12121A] rounded-xl overflow-hidden border border-zinc-800 transition-all hover:border-zinc-700 flex flex-col">
            <div className="h-48 w-full bg-zinc-800 relative">
              <img src="https://placehold.co/600x400/2a2a2a/ffffff?text=Promokna.id" alt="Promokna.id" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-[17px] font-bold text-white mb-2 leading-tight">Promokna.id - Event, Brand, Business Promotion</h3>
              <p className="text-[#60A5FA] text-[13px] font-medium mb-4">Laravel, Alpinejs, TailwindCSS</p>
              <p className="text-zinc-400 text-[14px] leading-[1.6]">
                Scalable service hub and landing page architecture for major regional events. I designed the platform for rapid deployment, successfully launching 8+ event sites in its first year. This infrastructure established the brand's dominant position in the digital promotion market.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
            ...
            <div className="col-span-1 lg:col-span-3 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-2 text-[13px]">
                ...
                <span className="text-zinc-600">zamkara</span>
              </div>
              <div className="flex items-center gap-2 text-[13px]">
              ...
              <div className="flex items-center gap-2 mt-2">
                <button aria-label="GitHub" className="w-9 h-9 rounded-md border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:text-white transition-colors">
                ...
                <button aria-label="Telegram" className="w-9 h-9 rounded-md border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:text-white transition-colors">
                ...
                <button aria-label="Key" className="w-9 h-9 rounded-md border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:text-white transition-colors">
                ...
                <button aria-label="Terminal" className="w-9 h-9 rounded-md border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:text-white transition-colors text-xs font-mono font-bold">
                  {">_"}
                </button>
                <button aria-label="RSS" className="w-9 h-9 rounded-md border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:text-white transition-colors">
            ...
            <div className="col-span-1 lg:col-span-5">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-[13px]">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="#" className="hover:text-white transition-colors">Mastodon</a>
                  <a href="#" className="hover:text-white transition-colors">Telegram</a>
                  <a href="#" className="hover:text-white transition-colors">LinkedIn</a>
                  <a href="#" className="hover:text-white transition-colors">Misskey</a>
                  <a href="#" className="hover:text-white transition-colors">Bluesky</a>
                  <a href="#" className="hover:text-white transition-colors">Matrix</a>
                  <a href="#" className="hover:text-white transition-colors">XMPP</a>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="#" className="hover:text-white transition-colors">PixHost</a>
                  <a href="#" className="hover:text-white transition-colors">Archive</a>
                  <a href="#" className="hover:text-white transition-colors">DropIt</a>
                  <a href="#" className="hover:text-white transition-colors">Ranoz</a>
